...
pkgdatadir = $(datadir)/modcom_server
pkglibdir = $(libdir)/modcom_server
pkgincludedir = $(includedir)/modcom_server
...
bin_PROGRAMS = modcom_server$(EXEEXT)
subdir = .
...
modcom_server_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(modcom_server_LDFLAGS) $(LDFLAGS) -o $@
DEFAULT_INCLUDES = -I.
...
LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	...
	$(LDFLAGS) -o $@
SOURCES = $(modcom_server_SOURCES)
DIST_SOURCES = $(modcom_server_SOURCES)
ETAGS = etags
CTAGS = ctags
...
NMEDIT = 
OBJEXT = o
PACKAGE = modcom_server
PACKAGE_BUGREPORT = 
PACKAGE_NAME = modcom_server
PACKAGE_STRING = modcom_server 0.1
PACKAGE_TARNAME = modcom_server
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
...
top_srcdir = .
AM_CPPFLAGS = \
	-DPACKAGE_DATA_DIR=\""$(datadir)"\" $(MODCOM_SERVER_CFLAGS)
...
modcom_server$(EXEEXT): $(modcom_server_OBJECTS) $(modcom_server_DEPENDENCIES) 
	@rm -f modcom_server$(EXEEXT)
	$(modcom_server_LINK) $(modcom_server_OBJECTS) $(modcom_server_LDADD) $(LIBS)
